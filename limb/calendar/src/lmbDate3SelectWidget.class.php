...
class lmbDate3SelectWidget extends lmbMacroInputWidget
{
  ...
  protected function _initDate3Select()
  {
    ...
    $this->dw_year_class = $this->getAttribute('year_class');
    $this->dw_month_class = ('' != $this->getAttribute('month_class')) ? $this->getAttribute('month_class') : $this->getAttribute('year_class');
    $this->dw_day_class = ('' != $this->getAttribute('day_class')) ? $this->getAttribute('day_class') : $this->getAttribute('year_class');
