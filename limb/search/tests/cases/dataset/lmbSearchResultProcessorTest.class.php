 ...
 * @version    $Id: lmbSearchResultProcessorTest.class.php 5629 2007-04-11 12:13:16Z pachanga $
 * @package    search
 */
...
class lmbSearchResultProcessorTest extends UnitTestCase
{
  function testLeftAndRightGaps()
  {
    ...
    $processor = new lmbSearchResultProcessor(new lmbIterator(array(array('content' => $result))));
