 ...
 * @version    $Id: lmbSearchResultProcessorTest.class.php 5003 2007-02-08 15:36:51Z pachanga $
 * @package    search
 */
...
class lmbSearchResultProcessorTest extends UnitTestCase
{
  function testLeftAndRightGaps()
  {
    ...
    $processor = new lmbSearchResultProcessor(new lmbArrayDataset(array(array('content' => $result))));
