 ...
 * @version    $Id: lmbFileUploadMaxSizeRule.class.php 5413 2007-03-29 10:08:00Z pachanga $
 * @package    validation
 */
...
class lmbFileUploadMaxSizeRule extends lmbSingleFieldRule
{
  ...
  function check($value)
  {
    ...
    {
      $this->error(lmb_i18n('{Field} - uploaded file was too large. Maximum size is {maxsize}.', 'validation'),
    ...
    {
      $this->error(lmb_i18n('{Field} - file was too large to upload.', 'validation'));
    }
  }
