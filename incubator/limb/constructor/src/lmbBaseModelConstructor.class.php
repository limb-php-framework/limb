...
class lmbBaseModelConstructor extends lmbAbstractConstructor
{
  protected $_model_template_file = 'model/base_model.phtml';
  ...
  {
    return 'lmb'.$this->_model_name . '.class.php';
  }
  ...
  function create($vars = null)
  {
    ...
    $vars['model_name'] = 'lmb'.$this->_model_name;
    ...
    $this->_project->addBaseModel($this->getModelFileName(), $model_content);
